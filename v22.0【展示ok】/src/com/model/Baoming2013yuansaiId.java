...
/**
 * Baoming2013yuansaiId entity. @author MyEclipse Persistence Tools
 */

public class Baoming2013yuansaiId implements java.io.Serializable {
	...
	/** default constructor */
	public Baoming2013yuansaiId() {
	}

	/** full constructor */
	public Baoming2013yuansaiId(String nb, String nm, String clas,
			String xueyuan, String iphone, String qq, String emai, Integer ad,
			String intro, String ti, String sex) {
		this.nb = nb;
		this.nm = nm;
		this.clas = clas;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Baoming2013yuansaiId))
			return false;
		Baoming2013yuansaiId castOther = (Baoming2013yuansaiId) other;
